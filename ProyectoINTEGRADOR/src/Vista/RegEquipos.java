...
public class RegEquipos extends JFrame {
	...
	public RegEquipos() {
		...
		textAreaNotas.setBounds(607, 134, 110, 55);
		...
		label_13.setBounds(532, 75, 65, 14);
		...
		textField_30.setBounds(404, 164, 86, 20);
		textField_30.setColumns(10);

		lblAlmacenamiento = new JLabel("Almacenamiento 1");
		lblAlmacenamiento.setBounds(287, 126, 116, 30);
		...
		textField_1.setBounds(111, 64, 86, 20);
		...
		JLabel lblAlmacenamiento_1 = new JLabel("Almacenamiento 2");
		lblAlmacenamiento_1.setFont(new Font("Tahoma", Font.PLAIN, 12));
		lblAlmacenamiento_1.setBounds(287, 158, 116, 30);
		contentPane.add(lblAlmacenamiento_1);

		JComboBox comboBox = new JComboBox();
		comboBox.setModel(new DefaultComboBoxModel(new String[] { "Paris", "Madrid", "Berlin" }));
		comboBox.setBounds(414, 58, 55, 20);
		contentPane.add(comboBox);

		JComboBox comboBox_1 = new JComboBox();
		comboBox_1.setModel(
				new DefaultComboBoxModel(new String[] { "Docencia", "Investigacion", "Administrativo", "Taller" }));
		comboBox_1.setBounds(619, 73, 79, 20);
